...
s.install_or_upgrade = async function s_install_or_upgrade() {
  ...
  if (local_version !== s.version.current()) {
    if (local_version === undefined) {
      ...
      await storageSet({'option_bookmarks_bar': '1'})
      await storageSet({'option_bookmarks_bar_sub': '1'})
      await storageSet({'option_other_bookmarks': '1'})
      await storageSet({'option_other_bookmarks_sub': '1'})
      await storageSet({'option_mobile_bookmarks': '1'})
      await storageSet({'option_mobile_bookmarks_sub': '1'})
